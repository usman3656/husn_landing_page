...
// Static export needs the full slug list up front, and "output: export"
// fails the build outright if a dynamic route resolves zero params. When
// there are no posts yet, fall back to one placeholder slug that 404s
// normally (never linked from the index, sitemap, or feed) so the build
// stays green until the first real post is added.
